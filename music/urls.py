...
from .views import (
    ...
    AiMusicSearchView,
    TagMusicSearchView,
    MusicDetailView,  # spotify_id 기반 상세 조회
...
urlpatterns = [
    ...
    # Spotify ID 기반 상세 조회 (DB에 없으면 Spotify API 조회 후 자동 저장)
    # GET /api/v1/tracks/{spotify_id}
    path('tracks/<str:spotify_id>', MusicDetailView.as_view(), name='track-detail'),
